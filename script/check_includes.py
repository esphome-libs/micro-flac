...
CMAKE_SOURCE = os.path.join(ROOT, "host_examples", "flac_to_wav")
CMAKE_ARGS = []
...
# XCHAL_* hardware macros -- unparseable without a real Xtensa toolchain.
EXCLUDE_DIRS = ["examples/test_lpc_asm"]
